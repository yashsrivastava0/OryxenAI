...
def derive_verification_plan(
    *,
    ...
    for interaction in plan.interactions:
        ...
        action = "focus" if "focus" in trigger else "press" if "key" in trigger else "click"
        selector = (
            str(interaction_data.get("target", "")) or f'[data-interaction-id="{interaction_id}"]'
        )
            ...
            VerificationJourney(
                ...
                steps=[
                    ...
                    VerificationStep(
                        ...
                        expected_url=str(interaction_data.get("expected_url", "")),
