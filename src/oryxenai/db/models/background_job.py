...
class BackgroundJob(Base):
    ...
    portfolio_session_id: Mapped[UUID | None] = mapped_column(
        ...
        ForeignKey(
            ...
            name="fk_background_jobs_portfolio_session",
            ondelete="RESTRICT",
        ),
        nullable=True,
    )
    owner_user_id: Mapped[UUID | None] = mapped_column(
        PGUUID(as_uuid=True),
        ForeignKey("app_users.id", name="fk_background_jobs_owner_user", ondelete="RESTRICT"),
        nullable=True,
    )
    actor_user_id: Mapped[UUID | None] = mapped_column(
        PGUUID(as_uuid=True),
        ForeignKey("app_users.id", name="fk_background_jobs_actor_user", ondelete="RESTRICT"),
        nullable=True,
    )
