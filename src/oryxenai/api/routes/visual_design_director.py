"""HTTP API for the Visual Design Director flow: start, revise, state, approve."""
...
class VisualDesignDirectorStateResponse(BaseModel):
    session_id: str
...
@router.post(
    "/start",
    response_model=VisualDesignDirectorStateResponse,
