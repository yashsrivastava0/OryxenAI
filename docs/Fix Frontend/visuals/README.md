...
These images are high-level UI references for the implementation AI. They are not production assets and do not override the Markdown contract.

| File | Reference |
|---|---|
| `01-shell-overview.png` | Desktop single-canvas control-room shell |
| `02-discovery-intake.png` | Focused Discovery intake |
| `03-discovery-review.png` | Summary-first brief review with action dock |
| `04-content-route-review.png` | Route map and selected route sections |
| `05-design-storyboard.png` | Visual thesis and visible scene storyboard |
| `06-preparation-ready.png` | Ready handoff with metadata evidence tiles |
| `07-generation-available.png` | Explicit generation entry after preparation |
| `08-generation-working.png` | Human-readable progress milestones |
