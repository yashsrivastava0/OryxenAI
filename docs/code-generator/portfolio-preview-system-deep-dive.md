...
class PreviewStorage(Protocol):
    ...
    async def put_conditional(self, *, key: str, data: bytes, content_type: str, expected_etag: str | None) -> PreviewObject: ...
    async def delete(self, key: str) -> None: ...
    async def list_prefix(self, prefix: str, *, limit: int = 100, continuation: str | None = None) -> tuple[list[str], str | None]: ...
```
